...
* The code used to generate the plot showing the distribution of labels within the train, validation, test, and exemplar datasets (Fig. 4) is available in the [`wa_hls4ml_models/notebooks`](wa_hls4ml_models/notebooks) directory. 
